...
<head>
    ...
    <title>Admin | Cert. of Eligibility Orders Folder</title>
        ...
        <div style=" background-color: white; border-radius: 0.5rem; padding: 1rem">
            <div class="row" style="margin-top: 0.5rem;">
                ...
                <div class="col-12" style="margin-top: -2rem">
                  ...
                  <span style="font-size: medium; font-weight: bold; color: #1D0A68;">Certificate of Eligibility Folder</span>
                </div>
                ...
                @if($fid == 0)
                <form method="post" action="{{ route('add_file_cert_eli') }}" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="col-6" style="margin-top: -1rem"> 
                    <label for="image">Add File in Certificate of Eligibility folder:</label>
                          ...
                          @foreach ($files as $f) 
                            <tr> 
                              ...
                              <td style="text-align: center">
                                <a class="link-buttons" href="{{ route('view_cert_eli', $f->id) }}">View</a>
                              </td>
                            </tr>
                          @endforeach 
                          </form>
